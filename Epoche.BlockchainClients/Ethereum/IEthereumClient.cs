...
public interface IEthereumClient : IBlockchainClient
{
    ...
    Task<BigFraction> GetBalanceAsync(string address, CancellationToken cancellationToken = default);
    Task<BigFraction> GetBalanceAtBlockAsync(string address, long blockNumber, CancellationToken cancellationToken = default);
    Task<BigFraction[]> GetBalancesAsync(IEnumerable<string> addresses, CancellationToken cancellationToken = default);
    ...
    Task<string> RawCallAtBlockAsync(string address, string data, long blockNumber, CancellationToken cancellationToken = default);
